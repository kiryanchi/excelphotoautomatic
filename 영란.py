...
class Rectangle(Shape):  # 서브 클래스
    ...
    def drawShape(self):  # 사각형 그리기로 오버라이딩
        ...
        self.objects = staticmethod  # 선분 리스트(=사각형)을 objects에 넣음
...
fileMenu.add_command(label="그림판 지우기", command=func_remove)
fileMenu.add_separator()
fileMenu.add_command(label="종료하기", command=func_exit)
